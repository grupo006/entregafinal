(function(){
  ...
  Hemisferios.draw = function(id, data, toolTip){   
    ...
    d3.select(id).selectAll(".state")
      .data(Hemisferio).enter().append("path").attr("class","state").attr("d",function(d){ return d.d;})
      .style("fill",function(d){ return data[d.id].color; })
      .on("mouseover", mouseOver).on("mouseout", mouseOut);
  }
  this.Hemisferios=Hemisferios;
})();
...
(function(){
  ...
  organos.draw = function(id, data, toolTip){   
    function mouseOver(d){
      d3.select("#tooltip").transition().duration(100).style("opacity", .9);      
    ...
    d3.select(id).selectAll(".states")
      .data(Organo).enter().append("path").attr("class","state").attr("d",function(d){ return d.d;})
      .style("fill",function(d){ return data[d.id].color; })
      .on("mouseover", mouseOver).on("mouseout", mouseOut);
  }
